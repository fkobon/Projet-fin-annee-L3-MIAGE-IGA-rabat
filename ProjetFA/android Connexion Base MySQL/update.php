...
if (isset($_POST['col1']) && isset($_POST['col2']) && isset($_POST['col3']) && isset($_POST['col4'])) {
    ...
    //$result = mysqli_query("UPDATE TableExemple SET col2 = '$value_col2', col3 = '$value_col3', col4 = '$value_col4' WHERE col1 = $value_col1");
	 $resultat = mysqli_query($db-> connection(),"UPDATE TableExemple SET col2 = '$value_col2', col3 = '$value_col3', col4 = '$value_col4' 
														WHERE col1 = $value_col1");
