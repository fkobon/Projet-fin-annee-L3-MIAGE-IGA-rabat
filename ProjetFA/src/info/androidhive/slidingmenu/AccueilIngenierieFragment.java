...
public class AccueilIngenierieFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.acceuil_ingenierie, container, false);
		
        
        viewFlipper = (ViewFlipper) rootView.findViewById(R.id.view_flipper);
        TextView textView= (TextView) rootView.findViewById(R.id.InfoGeneralIng);
...
//	     viewFlipper.setInAnimation(slideLeftIn);
       ...
       // TextView tv =(TextView)rootView.findViewById(R.id.InfoGeneralIng);
       // Animation translatebu= AnimationUtils.loadAnimation(getActivity(), R.animator.animationfile);
       // translatebu.setFillAfter(true);
